...
Identify patterns leading to customer churn (loss) or loyalty.
...
Detect increases or decreases and identify timelines or patterns (seasonal changes, promo impacts, etc.).
